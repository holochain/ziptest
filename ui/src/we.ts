      ...
      if (wal.context !== "_all") {
        ...
        if (PROFILES_CLIENT) {
          for (const m of members) {
            ...
            if (profile) names.push(profile.entry.nickname);
          }
        } else {
