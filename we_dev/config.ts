...
export default defineConfig({
  groups: [
    {
      ...
      applets: [
        {
          name: 'ZipTest Hot Reload',
          instanceName: 'ZipTest Hot Reload',
          registeringAgent: 1,
          joiningAgents: [2,3],
        },
        {
  ...
  applets: [
    ...
    },
    {
        ...
        source: {
          type: "https",
          url: "https://github.com/holochain-apps/kando/releases/download/v0.11.2/kando.webhapp"
        },
      },
    //   {
    //   name: 'notebooks',
